...
void command_line(TaxPar &par)
{
  ...
  cerr << "  -ntrans number_of_transactions (default: "
       << par.ntrans << ")\n";
  cerr << "  -tlen avg_items_per_transaction (default: " << par.tlen << ")\n";
  cerr << "  -nitems number_of_different_items (default: "
       << par.nitems << ")\n";
